...
As of 2026-08-16 this directory holds six documents. Several previously
...
calibration analysis, and a TIAGo port review) have since been merged into
two combined documents rather than kept as cross-linked siblings — the
table below reflects the current, post-merge state, not the historical
filenames referenced by older commits.
