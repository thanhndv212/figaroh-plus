...
def get_baseParams(W_e, params_r, params_std):
    """Returns symbolic expressions of base parameters and base regressor matrix and
    idenx of the base regressor matrix."""
    # scipy has QR pivoting using Householder reflection
    Q, R = np.linalg.qr(W_e)
