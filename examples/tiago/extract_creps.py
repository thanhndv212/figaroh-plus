...
for base in ["base1", "base2", "base3"]:
    for shoulder in ["shoulder1", "shoulder2", "shoulder3", "shoulder4"]:
        for gripper in ["gripper3"]:
            ...
            gripper_shoulder, gripper_shoulder_rpy = pu.project_frame(
                gripper_frame, shoulder_frame, rot=True
            )
            shoulder_base, shoulder_base_rpy = pu.project_frame(
                shoulder_frame, base_frame, rot=True
            )
            ...
            pu.save_selected_data(
                ...
                join(
                    ...
                    "data/calibration/mocap/vicon/relative_encoder/vicon_calibration_fc10_{}_{}_withrpy.csv".format(
                        gripper, base
                    ),
                ),
            )
