...
viz.viewer.gui.addXYZaxis('world/base', [0, 0., 1., 1.], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/angle_motor', [0, 0., 1., 1.], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/q_1', [0, 0., 1., 1.], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/lower_arm', [0, 0., 1., 1.], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/upper_arm', [0, 0., 1., 1.], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/tool', [0, 0., 1., 0.6], 0.008, 0.1)
viz.viewer.gui.addXYZaxis('world/end_effector', [0, 0., 1., 0.6], 0.008, 0.1)
viz.viewer.gui.addSphere('world/ee_sphere', 0.01, [255, 0., 0, 1.])
